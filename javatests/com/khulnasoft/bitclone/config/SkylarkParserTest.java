...
import com.khulnasoft.bitclone.exception.CannotResolveLabel;
...
public class SkylarkParserTest {
  ...
  private static final String NON_IMPORTANT_WORKFLOW = "core.workflow(\n"
      ...
      + "      folder = \"not_used\"\n"
      + "   ),\n"
      + "   authoring = authoring.overwrite('Bitclone <not_used@google.com>'),\n"
      + ")\n";
  ...
  private String setUpInclusionTest() {
    parser.addConfigFile(
        ...
        ""
            ...
            + "baz=bar\n"
            + "def copy_author():\n"
            + "  return authoring.overwrite('Bitclone <no-reply@google.com>')");
    parser.addConfigFile(
        "foo/bar.bara.sky",
        ""
            + "load('bar/foo', 'foobar')\n"
  ...
  /**
   * This test checks that we can load a basic Bitclone config file. This config file uses almost
  ...
  public void testLoadImportsOfConfigFile() throws Exception {
    ...
    assertThat(includeMap).containsKey("bit.clone.sky");
  ...
  public void testLoadImportsIdempotent() throws Exception {
    ...
    ConfigFile derivedConfig =
        new MapConfigFile(ImmutableMap.copyOf(contentMap), "bit.clone.sky");
  ...
  public void testTransformsAreOptional()
    ...
    String configContent = ""
        ...
        + "      folder = 'some folder'\n"
        + "   ),\n"
        + "   authoring = authoring.overwrite('Bitclone <no-reply@google.com>'),\n"
        + ")\n";
  ...
  public void testResolveLabelDeps() throws Exception {
    ...
    assertThat(deps.get("bit.clone.sky").readContent()).isEqualTo(content);
