...
public class TransformWorkTest {
  ...
  public void testGetLabel() {
    ...
    assertThat(work.getAllLabels("BITCLONE_AUTHOR")).containsExactly("Foo Bar", "foo@bar.com");
  ...
  public void testGetDateLabel_null() {
    ...
    assertThat(workNullTime.getLabel("BITCLONE_CURRENT_REV_DATE_TIME")).isEqualTo(null);
  }
  ...
  public void testGetDateLabel_value() {
    ...
    assertThat(work.getLabel("BITCLONE_CURRENT_REV_DATE_TIME")).isEqualTo("2020-06-09T22:57:37Z");
   }
