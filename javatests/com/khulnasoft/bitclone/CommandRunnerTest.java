...
import com.khulnasoft.bitclone.util.CommandRunner.CommandExecutor;
import com.khulnasoft.bitclone.util.CommandTimeoutException;
import com.khulnasoft.bitclone.shell.AbnormalTerminationException;
import com.khulnasoft.bitclone.shell.Command;
import com.khulnasoft.bitclone.shell.CommandException;
import com.khulnasoft.bitclone.shell.Killable;
import com.khulnasoft.bitclone.shell.KillableObserver;
import com.khulnasoft.bitclone.shell.TerminationStatus;
...
public class CommandRunnerTest {
  ...
  public void testTimeout() throws Exception {
    ...
    assertThat(e.getMessage())
          .containsMatch("Command '.*' killed by Bitclone after timeout \\(1s\\)");
  ...
  public void testObserverCanTerminate() throws Exception {
    ...
    assertThat(e)
        .hasMessageThat()
        .doesNotContainMatch("Command '.*' killed by Bitclone after timeout \\(1s\\)");
  }
