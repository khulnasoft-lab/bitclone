...
import static com.khulnasoft.bitclone.testing.git.GitTestUtil.mockGitHubNotFound;
import static com.khulnasoft.bitclone.testing.git.GitTestUtil.mockGitHubUnauthorized;
...
public class GitHubEndpointTest {
  ...
  public void setup() throws Exception {
    ...
    gitUtil.mockApi(eq("POST"), contains("/statuses/e59774"),
        mockResponse("{\n"
            + "    \"state\": \"success\",\n"
            + "    \"target_url\": \"https://github.com/khulnasoft-lab/example\",\n"
    ...
    gitUtil.mockApi(
        ...
        mockResponse(
            "{\n"
                + "    \"ref\": \"refs/heads/test\",\n"
                + "    \"url\": \"https://github.com/khulnasoft-lab/example/git/refs/heads/test\",\n"
                + "    \"object\": { \n"
                + "       \"type\": \"commit\",\n"
                + "       \"sha\": \"e597746de9c1704e648ddc3ffa0d2096b146d600\", \n"
                + "       \"url\":"
                + " \"https://github.com/khulnasoft-lab/example/git/commits/e597746de9c1704e648ddc3ffa0d2096b146d600\"\n"
                + "   } \n"
                + "}"));
  ...
  public void testParsing() throws Exception {
    skylark.eval(
        "e",
        "e = git.github_api(url = 'https://github.com/khulnasoft-lab/example')");
  }
  ...
  public void testCheckerIsHonored() throws Exception {
    ...
    assertThat(actionMigration.getDestinationDescription().get("url"))
        .containsExactly("https://github.com/khulnasoft-lab/example");
  ...
  public void testCreateStatusExhaustive() throws Exception {
    runFeedback(ImmutableList.<String>builder()
        ...
        .addAll(checkFieldStarLark("res", "target_url", "'https://github.com/khulnasoft-lab/example'"))
  ...
  public void testFeedbackUpdateReference() throws Exception{
    runFeedback(ImmutableList.<String>builder()
        ...
        .addAll(checkFieldStarLark("res", "url",
            "'https://github.com/khulnasoft-lab/example/git/refs/heads/test'"))
  ...
  public void testFeedbackDeleteReference_masterCheck() {
    ...
    assertThat(expected).hasMessageThat().contains("Bitclone doesn't allow to delete master");
