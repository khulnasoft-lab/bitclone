...
public class ConsoleProfilerListenerTest {
  ...
  public void testConsoleProfilerListener() {
    ...
    console.assertThat()
        .matchesNextSkipAhead(VERBOSE, "PROFILE:.*6 //bitclone/iterative/origin.checkout")
        .matchesNextSkipAhead(VERBOSE, "PROFILE:.*21 //bitclone/iterative/transforms")
        .matchesNextSkipAhead(VERBOSE, "PROFILE:.*4 //bitclone/iterative/destination.write")
        .matchesNextSkipAhead(VERBOSE, "PROFILE:.*45 //bitclone/iterative")
        .matchesNextSkipAhead(VERBOSE, "PROFILE:.*47 //bitclone");
  }
