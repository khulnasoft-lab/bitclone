...
public class MainTest {
  ...
  private final String[] args = {"bit.clone.sky"};
  ...
  public void testRelativePath() throws IOException, ValidationException {
    ...
    Files.write(
        options.general.getFileSystem().getPath("/work").resolve("bit.clone.sky"),
        "".getBytes(UTF_8));
    ConfigLoaderProvider clp = main.newConfigLoaderProvider(skylark.createModuleSet());

    ConfigLoader loader = clp.newLoader("./bit.clone.sky", "test");
    assertThat(loader.location()).isEqualTo("/work/bit.clone.sky");
  }
