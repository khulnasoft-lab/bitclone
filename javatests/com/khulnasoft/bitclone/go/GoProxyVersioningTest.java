...
package com.khulnasoft.bitclone.go;
...
import com.khulnasoft.bitclone.version.VersionResolver;
...
public class GoProxyVersioningTest {
  ...
  public void testGoProxyVersionList_validListResponse(String content) throws Exception {
    setUpMockTransportForSkylarkExecutor(
        ImmutableMap.of("https://proxy.golang.org/github.com/khulnasoft-lab/example/@v/list", content));
    VersionList versionList =
        skylark.eval(
            "version_list",
            "version_list = go.go_proxy_version_list(module='github.com/khulnasoft-lab/example')");
  ...
  public void testGoProxyVersionList_noVersionListAnywhere() throws Exception {
    setUpMockTransportForSkylarkExecutor(
        ImmutableMap.of(
            "https://proxy.golang.org/github.com/khulnasoft-lab/example/@v/list",
            "",
            "https://proxy.golang.org/github.com/khulnasoft-lab/example/@latest",
            ""));
    VersionList versionList =
        skylark.eval(
            "version_list",
  ...
  public void testGoProxyVersionList_useDotInfoData() throws Exception {
    setUpMockTransportForSkylarkExecutor(
        ImmutableMap.of(
            ...
            "https://proxy.golang.org/github.com/khulnasoft-lab/example/@latest",
            "",
            "https://proxy.golang.org/github.com/khulnasoft-lab/example/@v/main.info",
            "{\"Version\":\"v0.5.9\",\"Time\":\"2022-10-02T22:41:56Z\",\"Origin\":{\"VCS\":\"git\""
                + ",\"URL\":\"https://github.com/khulnasoft-lab/example\",\"Ref\":\"refs/tags/v0.5.9\","
  ...
  public void testGoProxyVersionResolver_loadListWithRespectToRef() throws Exception {
    setUpMockTransportForSkylarkExecutor(
        ImmutableMap.of(
            ...
            "https://proxy.golang.org/github.com/khulnasoft-lab/example/@latest",
            "",
            "https://proxy.golang.org/github.com/khulnasoft-lab/example/@v/legacy_branch.info",
            "{\"Version\":\"v0.5.9\",\"Time\":\"2022-10-02T22:41:56Z\",\"Origin\":{\"VCS\":\"git\""
                + ",\"URL\":\"https://github.com/khulnasoft-lab/example\",\"Ref\":\"refs/tags/v0.5.9\","
                + "\"Hash\":\"a97318bf6562f1ed2632c5f985db51b1ac5bdcd0\"}}"));
    VersionResolver versionResolver =
        skylark.eval(
            "version_resolver",
            "version_resolver = go.go_proxy_resolver(module='github.com/khulnasoft-lab/example')");
    Revision revision =
        versionResolver.resolve(
            ...
            (version) ->
                Optional.of(
                    String.format(
                        "https://proxy.golang.org/github.com/khulnasoft-lab/example/@v/%s.zip", version)));
    assertThat(revision.getUrl())
        .isEqualTo("https://proxy.golang.org/github.com/khulnasoft-lab/example/@v/v0.5.9.zip");
  }
  ...
  public void testGoProxyVersionList_getInfoQuery_withRef() throws Exception {
    ...
    GoVersionObject versionObj =
        skylark.eval(
            "version_object",
            "version_object = go.go_proxy_version_list(module='github.com/khulnasoft-lab/example',"
                + " ref='main').get_info()");
    ...
    assertThat(versionObj.getOrigin().getUrl()).isEqualTo("https://github.com/khulnasoft-lab/example");
  ...
  public void testGoProxyVersionList_getInfoQuery_withoutRef() throws Exception {
    ...
    GoVersionObject versionObject =
        skylark.eval(
            "version_object",
            "version_object ="
                + " go.go_proxy_version_list(module='github.com/khulnasoft-lab/example').get_info()");
    ...
    assertThat(versionObject.getOrigin().getUrl()).isEqualTo("https://github.com/khulnasoft-lab/example");
  ...
  public void testGoProxyVersionList_manualRef() throws Exception {
    setUpMockTransportForSkylarkExecutor(
        ImmutableMap.of(
            "https://proxy.golang.org/github.com/khulnasoft-lab/example/@v/v0.5.9.info",
            "{\"Version\":\"v0.5.9\",\"Time\":\"2022-10-02T22:41:56Z\",\"Origin\":{\"VCS\":\"git\""
                + ",\"URL\":\"https://github.com/khulnasoft-lab/example\",\"Ref\":\"refs/tags/v0.5.9\","
                + "\"Hash\":\"a97318bf6562f1ed2632c5f985db51b1ac5bdcd0\"}}"));
    ...
    GoVersionObject versionObject =
        skylark.eval(
            "version_object",
            "version_object ="
                + " go.go_proxy_version_list(module='github.com/khulnasoft-lab/example').get_info(ref ="
                + " \"v0.5.9\")");
    assertThat(versionObject.getVersion()).isEqualTo("v0.5.9");
    assertThat(versionObject.getTime()).isEqualTo("2022-10-02T22:41:56Z");
    assertThat(versionObject.getOrigin().getVcs()).isEqualTo("git");
