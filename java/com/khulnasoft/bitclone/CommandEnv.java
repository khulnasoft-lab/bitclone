...
public class CommandEnv {
  ...
  /**
   * Instantiate a new CommandEnv. Meant for use with construction of new BitcloneCmd objects
   */
  public CommandEnv(Path workdir, Options options, ImmutableList<String> args) {
   ...
   */
  public ConfigFileArgs parseConfigFileArgs(BitcloneCmd cmd, boolean usesSourceRef)
