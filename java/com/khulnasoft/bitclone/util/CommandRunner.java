...
import com.khulnasoft.bitclone.shell.BadExitStatusException;
...
import com.khulnasoft.bitclone.shell.ShellUtils;
import com.khulnasoft.bitclone.shell.TerminationStatus;
import com.khulnasoft.bitclone.shell.TimeoutKillableObserver;
...
private static class DefaultExecutor implements CommandExecutor {
  ...
  private void maybeTreatTimeout(ByteArrayOutputStream stdoutCollector,
    ...
    String msg = String.format(
        "Command '%s' killed by Bitclone after timeout (%ds)."
