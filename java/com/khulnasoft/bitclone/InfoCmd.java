...
import com.khulnasoft.bitclone.monitor.EventMonitor.InfoFailedEvent;
...
import com.khulnasoft.bitclone.util.TablePrinter;
...
public class InfoCmd implements BitcloneCmd {
  ...
  private static void showAllMigrations(CommandEnv commandEnv, Config config) {
    ...
    console.info("To get information about the state of any migration run:\n\n"
        + "    bitclone info " + config.getLocation() + " [workflow_name]"
        + "\n");
  }
