...
import static com.khulnasoft.bitclone.WorkflowOptions.CHANGE_REQUEST_FROM_SOT_LIMIT_FLAG;
import static com.khulnasoft.bitclone.WorkflowOptions.CHANGE_REQUEST_PARENT_FLAG;
import static com.khulnasoft.bitclone.exception.ValidationException.checkCondition;
import static com.khulnasoft.bitclone.exception.ValidationException.retriableException;
  ...
  SQUASH {
    ...
    <O extends Revision, D extends Revision> void run(WorkflowRunHelper<O, D> runHelper)
      ...
      Metadata metadata = new Metadata(
          runHelper.getChangeMessage("Project import generated by Bitclone.\n"),
          ...
          throw new EmptyChangeException(
              String.format(
                  "'%s' has been already migrated. Use %s if you really want to run the migration"
                      + " again (For example if the bit.clone.sky file has changed).",
