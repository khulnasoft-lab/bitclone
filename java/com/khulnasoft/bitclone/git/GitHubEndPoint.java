...
import com.khulnasoft.bitclone.git.github.api.GitHubApi.PullRequestListParams.DirectionFilter;
import com.khulnasoft.bitclone.git.github.api.GitHubApi.PullRequestListParams.SortFilter;
import com.khulnasoft.bitclone.git.github.api.GitHubApi.PullRequestListParams.StateFilter;
...
public class GitHubEndPoint implements Endpoint, StarlarkValue {
  ...
  @StarlarkMethod(
      ...
      parameters = {
        ...
        @Param(
            name = "context",
            doc =
                "The context for the commit status. Use a value like 'bitclone/import_successful'"
                    + " or similar",
            named = true),
  ...
  @StarlarkMethod(
      name = "get_references",
      doc =
          "Get all the reference SHA-1s from GitHub. Note that Bitclone only returns a maximum "
              + "number of 500.")
