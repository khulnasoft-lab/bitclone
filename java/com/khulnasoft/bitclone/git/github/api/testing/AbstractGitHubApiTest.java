...
import static com.khulnasoft.bitclone.git.github.api.GitHubApi.PullRequestListParams.DirectionFilter.ASC;
import static com.khulnasoft.bitclone.git.github.api.GitHubApi.PullRequestListParams.SortFilter.CREATED;
...
import com.khulnasoft.bitclone.git.github.api.AddAssignees;
import com.khulnasoft.bitclone.git.github.api.AddLabels;
import com.khulnasoft.bitclone.git.github.api.AuthorAssociation;
import com.khulnasoft.bitclone.git.github.api.CheckRun;
import com.khulnasoft.bitclone.git.github.api.CheckSuite;
import com.khulnasoft.bitclone.git.github.api.CombinedStatus;
import com.khulnasoft.bitclone.git.github.api.CommentBody;
import com.khulnasoft.bitclone.git.github.api.CreatePullRequest;
import com.khulnasoft.bitclone.git.github.api.CreateReleaseRequest;
import com.khulnasoft.bitclone.git.github.api.CreateStatusRequest;
import com.khulnasoft.bitclone.git.github.api.GitHubApi;
import com.khulnasoft.bitclone.git.github.api.GitHubApi.PullRequestListParams;
...
import com.khulnasoft.bitclone.git.github.api.GitHubCommit;
import com.khulnasoft.bitclone.git.github.api.Installation;
import com.khulnasoft.bitclone.git.github.api.Issue;
import com.khulnasoft.bitclone.git.github.api.Issue.CreateIssueRequest;
import com.khulnasoft.bitclone.git.github.api.IssueComment;
import com.khulnasoft.bitclone.git.github.api.IssuesAndPullRequestsSearchResults;
import com.khulnasoft.bitclone.git.github.api.IssuesAndPullRequestsSearchResults.IssuesAndPullRequestsSearchResult;
import com.khulnasoft.bitclone.git.github.api.Label;
import com.khulnasoft.bitclone.git.github.api.Organization;
import com.khulnasoft.bitclone.git.github.api.PullRequest;
import com.khulnasoft.bitclone.git.github.api.PullRequestComment;
import com.khulnasoft.bitclone.git.github.api.Ref;
import com.khulnasoft.bitclone.git.github.api.Release;
import com.khulnasoft.bitclone.git.github.api.Review;
import com.khulnasoft.bitclone.git.github.api.Status;
import com.khulnasoft.bitclone.git.github.api.Status.State;
import com.khulnasoft.bitclone.git.github.api.UpdatePullRequest;
import com.khulnasoft.bitclone.git.github.api.UpdateReferenceRequest;
import com.khulnasoft.bitclone.git.github.api.User;
import com.khulnasoft.bitclone.git.github.api.UserPermissionLevel;
import com.khulnasoft.bitclone.git.github.api.UserPermissionLevel.GitHubUserPermission;
...
public abstract class AbstractGitHubApiTest {
  ...
  public void testGetLsRemote() throws Exception {
    trainMockGet(
        "/repos/bitclone-test/bitclone/git/refs?per_page=100",
        getResource("lsremote_testdata.json"));
    ImmutableList<Ref> refs = api.getLsRemote("bitclone-test/bitclone");
    ...
    assertThat(refs.get(0).getUrl())
        .isEqualTo("https://api.github.com/repos/bitclone-test/bitclone/git/refs/heads/master");
  ...
  public void testGetLsRemote_empty() throws Exception {
    trainMockGetWithHeaders("/repos/bitclone-test/bitclone/git/refs?per_page=100",
        ("{\n"
  ...
  public void testGetLsRemote_fail() throws Exception {
    trainMockGetWithHeaders("/repos/bitclone-test/bitclone/git/refs?per_page=100",
        ...
        404);
    try {
      api.getLsRemote("bitclone-test/bitclone");
      fail();
  ...
  public void testCommit() throws Exception {
    ...
    assertThat(r.getAuthor().getLogin()).isEqualTo("bitclone-author");
    assertThat(r.getCommitter().getLogin()).isEqualTo("bitclone-committer");
    assertThat(r.getHtmlUrl()).isEqualTo(
        "https://github.com/khulnasoft.bitclone/commit/604aa8e189a6fee605140ebbe4a3c34ad24619d1");
  ...
  public void testAddAssignees() throws Exception {
    ImmutableList<String> assignees = ImmutableList.of("bitclone", "octocat");
    trainMockPost(
  ...
  public void testGetIssuesOrPullRequestsSearchResults() throws Exception {
    ...
    String project = "khulnasoft.bitclone";
    trainMockGet(
