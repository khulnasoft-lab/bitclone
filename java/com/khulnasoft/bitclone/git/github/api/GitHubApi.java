...
import static com.khulnasoft.bitclone.git.github.api.GitHubApiException.ResponseCode.CONFLICT;
...
public class GitHubApi {
   ...
   * @param projectId a project in the form of "khulnasoft.bitclone"
   */
  ...
  public static class IssuesAndPullRequestsSearchRequestParams {
     ...
     *
     * @param repo - project name in the example form of khulnasoft.bitclone
  ...
  public void deleteReference(String projectId, String ref)
    ...
    checkArgument(!ref.equals("refs/heads/master"), "Bitclone doesn't allow to delete master"
  ...
  public CombinedStatus getCombinedStatus(String projectId, String ref)
    ...
    try (ProfilerTask ignore = profiler.start("github_api_get_combined_status")) {
      // TODO(bitclone-team): We might consider add paginatedGet to get all the statuses of a ref
