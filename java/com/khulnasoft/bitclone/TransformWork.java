...
import com.khulnasoft.bitclone.doc.annotations.DocSignaturePrefix;
...
import com.khulnasoft.bitclone.treestate.TreeState;
...
public final class TransformWork extends CheckoutFileSystem
  ...
  static final String BITCLONE_CONTEXT_REFERENCE_LABEL = "BITCLONE_CONTEXT_REFERENCE";
  ...
  static final String BITCLONE_LAST_REV = "BITCLONE_LAST_REV";
  static final String BITCLONE_CURRENT_REV = "BITCLONE_CURRENT_REV";
  static final String BITCLONE_CURRENT_REV_DATE_TIME = "BITCLONE_CURRENT_REV_DATE_TIME";
  static final String BITCLONE_CURRENT_MESSAGE = "BITCLONE_CURRENT_MESSAGE";
  static final String BITCLONE_AUTHOR = "BITCLONE_AUTHOR";
  static final String BITCLONE_CURRENT_MESSAGE_TITLE = "BITCLONE_CURRENT_MESSAGE_TITLE";

  static final String BITCLONE_CONFIG_PATH_LABEL = "BITCLONE_CONFIG_PATH";

  static final String BITCLONE_WORKFLOW_NAME_LABEL = "BITCLONE_WORKFLOW_NAME";
  ...
  @StarlarkMethod(
      ...
      parameters = {
        ...
        @Param(
            name = "whole_message",
            doc =
                "By default Bitclone only looks in the last paragraph for labels. This flag"
  ...
  private Map<String, ImmutableList<String>> getCoreLabels() {
    ...
    labels.put(BITCLONE_CONTEXT_REFERENCE_LABEL, ctxRef == null
        ? ImmutableList.of()
        : ImmutableList.of(ctxRef));
    // Alias to capture a parallel development
    labels.put(CONTEXT_REFERENCE_LABEL, labels.get(BITCLONE_CONTEXT_REFERENCE_LABEL));

    labels.put(BITCLONE_LAST_REV, lastRev == null
        ? ImmutableList.of()
    ...
    labels.put(BITCLONE_CURRENT_REV, currentRev == null
        ? ImmutableList.of()
        // Skip anything after space in the revision, since we might include metadata like
        // snapshot number, etc. that is subject to change.
        : ImmutableList.of(
    ...
    labels.put(BITCLONE_CURRENT_MESSAGE, ImmutableList.of(getMessage()));
    labels.put(BITCLONE_AUTHOR, ImmutableList.of(getAuthor().getName(), getAuthor().getEmail()));
    labels.put(BITCLONE_CURRENT_MESSAGE_TITLE,
  ...
  private void setDateForCurrentRev(Map<String, ImmutableList<String>> labels) {
    if (currentRev == null) {
      labels.put(BITCLONE_CURRENT_REV_DATE_TIME, ImmutableList.of());
      return;
    }
    ...
    labels.put(
        BITCLONE_CURRENT_REV_DATE_TIME,
