...
public interface Destination<R extends Revision> extends ConfigItemDescription, StarlarkValue {
  ...
  interface PatchRegenerator {
    /**
     * Write the files in the workdir to an already-existing change created by Bitclone. This is
     ...
     * non-bitclone edited patch-inconsistent state for which patch files need to be regenerated,
