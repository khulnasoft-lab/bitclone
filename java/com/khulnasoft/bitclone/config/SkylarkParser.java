...
/**
 * Loads Bitclone configs out of Skylark files.
 */
public class SkylarkParser {
  ...
  private final class Evaluator {
    ...
    private Module eval(ConfigFile content)
      ...
      try (Mutability mu = Mutability.create("BitcloneModules")) {
  ...
  // TODO(bitclone-team): evaluate the cleaner approach of saving the varying parts in the
