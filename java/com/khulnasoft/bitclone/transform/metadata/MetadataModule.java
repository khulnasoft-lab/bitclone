...
public class MetadataModule implements StarlarkValue {
  ...
  @StarlarkMethod(
      ...
      parameters = {
        @Param(
            ...
            defaultValue = "'Bitclone import of the project:\\n\\n'"),
        @Param(
            name = "max",
            named = true,
            doc =
  ...
  @StarlarkMethod(
      ...
      parameters = {
        ...
        @Param(
            ...
            named = true,
            doc =
                "By default Bitclone tries to find the most relevant instance of the label."
        ...
        @Param(
            ...
            named = true,
            doc =
                "If all is set, bitclone will expose multiple values in one per line. If a "
  ...
  @StarlarkMethod(
      ...
      parameters = {
        ...
        @Param(
            ...
            named = true,
            doc =
                "By default Bitclone only looks in the last current change for the author label."
  ...
  @Example(
      ...
      code = "metadata.add_header(\"BITCLONE CHANGE\")",
      after =
          "Messages like:\n\n"
              + "```\n"
              + "A change\n\n"
  ...
  @Example(
      ...
      before =
          "Adds a header to messages that contain a label. Otherwise it skips the message"
              + " manipulation.",
      code =
          "metadata.add_header(\"BITCLONE CHANGE FOR"
  ...
  @Example(
      ...
      code = "metadata.add_header(\"BITCLONE CHANGE: \", new_line = False)",
      after =
          "Messages like:\n\n"
              + "```\n"
              + "A change\n\n"
  ...
  @StarlarkMethod(
      ...
      parameters = {
        ...
        @Param(
            ...
            named = true,
            doc = "If set, Bitclone will use this text when the scrubbing regex doesn't match.",
            defaultValue = "None"),
        @Param(
  ...
  @StarlarkMethod(
      ...
      parameters = {
        ...
        @Param(
            ...
            defaultValue = "[]",
            doc =
                "Meant to be used when migrating from another tool: Per default, bitclone will"
