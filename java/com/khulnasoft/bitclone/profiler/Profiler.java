...
public final class Profiler {
  ...
  @VisibleForTesting
  public static final String ROOT_NAME = "//bitclone";
  ...
  final InheritableThreadLocal<Deque<Task>> taskQueue =
    ...
    protected Deque<Task> childValue(Deque<Task> parentValue) {
      ...
      // event for the root task ("//bitclone").
     ...
     * their own thread pool outside of Bitclone.
     *
     */
    @Override
  ...
  /**
   * Call this method once at the beginning of Bitclone binary run.
  ...
  /**
   * Call this method once at the end of the Bitclone binary run.
   */
  public void stop(){
    if (listeners.isEmpty()) {
      return;
