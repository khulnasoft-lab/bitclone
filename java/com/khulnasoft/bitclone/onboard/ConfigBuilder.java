...
public class ConfigBuilder {
  ...
  private final com.khulnasoft.bitclone.onboard.ConfigTemplate configTemplate;
  private String configInProgress;
  private final Map<String, String> keywordParams = new LinkedHashMap<>();

  public ConfigBuilder(com.khulnasoft.bitclone.onboard.ConfigTemplate configTemplate) {
    this.configTemplate = configTemplate;
    this.configInProgress = configTemplate.getTemplateString();
  }

  public ImmutableSet<com.khulnasoft.bitclone.onboard.RequiredField> getRequiredFields() {
      ...
      throw new IllegalStateException(
          String.format(
              ...
              configTemplate.getRequiredFields().stream()
                  .map(com.khulnasoft.bitclone.onboard.RequiredField::name)
                  .collect(toList())));
    }
