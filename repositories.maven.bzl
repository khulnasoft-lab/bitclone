...
BITCLONE_MAVEN_ARTIFACT_ADDITIONAL_REPOSITORIES = [
    "https://maven.google.com",
]

def bitclone_maven_repositories():
    maybe(
        maven_install,
        name = DEFAULT_REPOSITORY_NAME,
        artifacts = BITCLONE_MAVEN_ARTIFACTS,
        repositories = BITCLONE_MAVEN_ARTIFACT_ADDITIONAL_REPOSITORIES + ["https://repo1.maven.org/maven2"],
    )
