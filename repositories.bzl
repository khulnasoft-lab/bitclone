...
def bitclone_repositories():
    ...
    maybe(
        http_archive,
        name = "rules_cc",
        sha256 = "3668cc258e608dc4e34355121de08780bb3ea387e2dfc5d57eed5f21ce37644e",
        strip_prefix = "rules_cc-b8d9580d805567eef4d26aa01d14067865fb89f4",
        url = "https://github.com/bazelbuild/rules_cc/archive/b8d9580d805567eef4d26aa01d14067865fb89f4.zip",
    )
    ...
    maybe(
        http_archive,
        name = "JCommander",
        sha256 = "4b769cc793f0c3402a573c50960c5c4f41da1152abb415c0a764abb6f070f728",
        urls = [
            "https://github.com/cbeust/jcommander/archive/748ddba20a28956332b413eaa99d7e8b5422104d.zip",
        ],
